...
public class AdR_CubeMappingTemplate extends JoglTemplate
{
	...
	public void display(GLAutoDrawable drawable)
	{
		...
		gl.glTexParameteri(GL.GL_TEXTURE_CUBE_MAP, GL.GL_TEXTURE_MIN_FILTER, textureFilterMode);
		...
		{
			// the glutSolidTeapot seems to be buggy, polygons are facing with their
			// back sides out
