 ...
 */
//
// Klasse runge wird als abstrakte Klasse eingeführt, da die rechte Seite f(x,y) der
// Differentialgleichung y' = f(x,y) erst in der abgeleiteten Klasse festgelegt wird
